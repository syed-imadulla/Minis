  ...
  for (let i = 0; i < 150; i++) {
    ...
    particle.animate(
      [
        ...
        {
          opacity: 0.8,
          transform: `translate(${dx * 0.3}px, ${dy * 0.3}px) rotate(120deg)`,
        },
        {
          opacity: 0,
          transform: `translate(${dx * 0.9}px, ${dy * 0.9}px) rotate(360deg)`,
        },
      ],
      {
        duration: 1800,
...
document.querySelectorAll(".btn, #equalBtn").forEach((button) => {
...
window.addEventListener("load", () => {
  document.querySelector(".calculator-card").animate(
    [
      {
        opacity: 0,
